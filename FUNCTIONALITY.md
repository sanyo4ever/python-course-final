...
- **Розумне розпізнавання:** спочатку перевіряє весь ввід, потім витягає частину команди (перші 1-4 слова)
- Працює навіть якщо користувач ввів аргументи після помилкової команди
