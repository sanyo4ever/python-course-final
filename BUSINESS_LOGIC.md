...
### 1. Підказки команд (з розумним розпізнаванням)

```python
Користувач вводить: "ad contact John"
Система: "Unknown command. Did you mean 'add contact'?"

Користувач вводить: "edit contac Alice phone=+380501234567"
Система: "Unknown command. Did you mean 'edit contact'?"

Алгоритм:
1. Спочатку перевіряємо весь ввід
2. Якщо не знайшли, витягаємо перші N слів (команду без аргументів)
3. Пробуємо різні комбінації слів (4, 3, 2, 1)
4. Використовуємо difflib.get_close_matches(cutoff=0.5)
```

**Особливості:**
- ✅ Працює навіть коли є багато аргументів
- ✅ Розпізнає довгі команди ("search notes by tag")
- ✅ Інтелектуально відсікає аргументи
